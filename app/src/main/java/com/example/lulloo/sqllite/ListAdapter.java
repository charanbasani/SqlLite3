...
public class ListAdapter extends BaseAdapter {
    ...
    SQl_Db1 my;
    public ListAdapter(Context context, List<Pojo> pojoList) {
       ...
       // image.setVisibility(View.GONE);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                my = new SQl_Db1(context);
                pojos.getName();
                boolean isinsertt=my.inserdata(pojos.getName(),pojos.getMarks(),pojos.getImage());
                if (isinsertt == true)
                    Toast.makeText(context, "Data Inserted into cart", Toast.LENGTH_LONG).show();
                else
